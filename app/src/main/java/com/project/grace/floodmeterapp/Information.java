...
import com.project.grace.floodmeterapp.dummy.DummyWeather;
...
public class Information extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv = rootView.findViewById(R.id.RVWeather);
        WeatherAdapter adapter = new WeatherAdapter(DummyWeather.weathers);
